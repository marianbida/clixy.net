...
<div class="row">
    ...
    <div class="row">
        ...
        <div class="large-2 columns">
            <a data-id="{{ $vv->id }}" data-action="edit" href="javascript:;" class="button tiny success radius">@lang('btn.edit')</a>
            <a data-id="{{ $vv->id }}" data-action="remove" href="javascript:;" class="button tiny alert radius">@lang('btn.delete')</a>
        </div>
    </div>
    @endif
    @endforeach
