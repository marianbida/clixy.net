...
<div class="row">
    ...
    <div class="large-2 columns">
        <a data-id="{{ $vv->id }}" data-action="edit" href="javascript:;" class="button tiny radius success">@lang('btn.edit')</a>
        <a data-id="{{ $vv->id }}" data-action="remove" href="javascript:;" class="button tiny radius alert">@lang('btn.delete')</a>
    </div>
</div>
@endif
@endforeach
