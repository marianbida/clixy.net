...
class ItemController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('item/item', ['module' => 'item', 'user' => $user, 'token' => csrf_token()]);
    }
    ...
    public function postList(Request $request)
    {
        ...
        $content = view('item/itemlist', ['module' => 'item', 'list' => $list])->render();
    ...
    public function postCreate(Request $request)
    {
        ...
        return response()->json(['id' => $o->id, 'state' => true, 'token' => csrf_token()]);
    }
    ...
    public function postDateList(Request $request)
    {
        ...
        $content = view('item/itemdatelist', ['list' => $list])->render();
        
        return response()->json(['list' => [], 'content' => $content, 'token' => csrf_token()]);
    }
