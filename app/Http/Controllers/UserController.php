...
class UserController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('user.user', ['module' => 'user', 'user' => $user, 'token' => csrf_token()]);
    }
    ...
    public function postList()
    {
        ...
        $content = view('user.userlist', ['list' => $list])->render();
    ...
    public function postGet(Request $request)
    {
        ...
        $content = $content = view('user.userform', ['module' => 'user', 'data' => $data])->render();
