...
class SliderController extends Controller
{
	...
	$user = $request->user() ? $request->user()->toArray() : ['id' => null];
        return view('slider/slider', ['user' => $user, 'token' => csrf_token()]);
    }
    ...
    public function postList(Request $request)
    {
        ...
        $content = view('slider/sliderlist', ['list' => $list])->render();
    ...
    public function postCreate(Request $request)
    {
        ...
        $token = csrf_token();
        return response()->json(['id' => $slide->id, 'token' => $token]);
    }
    ...
    public function postGet(Request $request)
    {
        ...
        $content = $content = view('slider/sliderform', ['data' => $data, 'lang_data' => $lang_data, 'lang_list' => $lang_list])->render();
