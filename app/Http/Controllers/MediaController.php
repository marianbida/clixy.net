...
class MediaController extends Controller
{
    public function postGetMediaPagination(Request $request)
    {
        ...
        $steps = ceil($total / 12);
        $pagination = view('common.ajaxpagination', [
        ...
        return response()->json(['pagination' => $pagination, 'token' => $token]);
    }
    ...
    public function postGetMediaDetailList(Request $request)
    {
        ...
        $content = view('multimedia.media_detail_list_ajax', [
            'obj' => $obj,
            'media_conf' => array(),
            'list' => $list
        ])->render();
        
        return response()->json(['content' => $content, 'token' => csrf_token()]);
    }
    ...
    public function postUpload(Request $request)
    {
        ...
        $directory = '/home/viptrip/laravel/public/';
        
        $state = true;
        
        $directory .= $mc->find($category_id)->directory;
