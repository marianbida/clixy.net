...
class ColorController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('color.color', ['module' => 'color', 'user' => $user, 'token' => csrf_token()]);
    }
    ...
    public function postList()
    {
        ...
        $content = view('color.colorlist', ['list' => $list])->render();
    ...
    public function postGet(Request $request)
    {
        ...
        $content = $content = view('color.colorform', ['module' => 'color', 'data' => $data, 'lang_data' => $lang_data, 'lang_list' => $lang_list])->render();
